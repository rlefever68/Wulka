...
namespace Wulka.Networking.Wcf
{
		...
		where T : class
	{
		...
		private readonly string configName = String.Empty;
		...
		protected void AssureProxy()
		{
			...
			if (cachedProxy == null)
			{
                if(!String.IsNullOrEmpty(configName))
                    ...
                    cachedProxy = CreateProxyInstanceFromBinding();
        ...
        protected virtual T CreateProxyInstanceFromBinding()
		{
			T instance = (T) Activator.CreateInstance(_instanceType, new object[] {_binding,_endpointAddress});
			return instance;
		}
		...
		public virtual System.ServiceModel.Description.ClientCredentials ClientCredentials
		{

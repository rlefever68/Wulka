...
namespace Wulka.Networking.Wcf.Utils
{
    static class WsdlUtils
    {
        public static ServiceDescription FindRootDescription(ServiceDescriptionCollection wsdls)
        {
            ...
            return (from ServiceDescription description in wsdls where description.Services.Count > 0 select description.Services[0].ServiceDescription).FirstOrDefault();
        }

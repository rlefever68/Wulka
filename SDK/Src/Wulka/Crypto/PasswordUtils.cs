...
namespace Wulka.Crypto
{
    ...
    public class PasswordUtils
    {
        ...
        /// <remarks>The length of the generated password will be determined at
        /// random. It will be no shorter than the minimum default and
        /// no longer than maximum default.</remarks>
        ...
        {
            return(Generate(DEFAULT_MIN_PASSWORD_LENGTH, DEFAULT_MAX_PASSWORD_LENGTH, useSpecialsChars));
        }
        ...
        public static string Generate(int minLength, int maxLength, bool useSpecialsChars)
        {
            ...
            for(int i = 0; i < password.Length; i++) {
                ...
                int nextGroupIdx = leftGroupsOrder[nextLeftGroupsOrderIdx]; // Index of the next character group to be processed.

                // Get the index of the last unprocessed characters in this group.
                int lastCharIdx = charsLeftInGroup[nextGroupIdx] - 1;            // Index of the last non-processed character in a group.

...
namespace Wulka.Utils
{
    ...
    public static class GeoUtils
    {
        ...
        /// <param name="dType">Type of the d.</param>
        /// <returns>System.Double.</returns>
        public static double LongDistanceTo(double sourceLat, double lat, double sourceLon, double lng, DistanceType dType)
        {
            var source = new GLatLng(sourceLat, sourceLon);
        ...
        /// <param name="dType">Type of the d.</param>
        /// <returns>System.Double.</returns>
        public static double LongRhumbDistanceTo(double sourceLat, double lat, double sourceLon, double lng, DistanceType dType)
        {
            var source = new GLatLng(sourceLat, sourceLon);
        ...
        /// <param name="dType">Type of the d.</param>
        /// <returns>System.Double.</returns>
        public static double RhumbDistanceTo(double sourceLat,double lat, double sourceLon, double lng, DistanceType dType)
        {
            var source = new GLatLng(sourceLat, sourceLon);

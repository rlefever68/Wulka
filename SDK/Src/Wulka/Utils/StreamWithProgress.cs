    ...
    public sealed class StreamWithProgress : Stream
    {
        ...
        private void DoProgressChanged(long bytesRead, long length)
        {
            if (OnProgressChanged != null)
                OnProgressChanged(this, new ProgressChangedEventArgs(bytesRead, length));
        ...
        public override int Read(byte[] buffer, int offset, int count)
        {
            ...
            _bytesRead += result;
            if (OnProgressChanged != null) OnProgressChanged(this, new ProgressChangedEventArgs(_bytesRead, _length));
            return result;
        }

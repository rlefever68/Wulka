...
// ***********************************************************************
// <copyright file="HighResTimer.cs" company="Broobu">
...
namespace Wulka.Utils
{
	...
	public class HighResTimer
	{
		...
		public double Duration
		{
			get
			{
				return (double)(_stop - _start) / (double)_frequency;
			}
		}
		...
		{
            return String.Format("{0} sec.", Duration.ToString("N03", CultureInfo.CurrentCulture));
		}
	}

...
namespace Wulka.BigD
{
    ...
    /// </summary>
    public class BigDServer : IBigDServer
    {
        ...
        public BigDServer(string host, int port, string user, string pass)
        {
            this.host = host;
            this.port = port;
            userName = user;
        ...
        public BigDServer(string host, int port): this(host, port, null, null)
        {
        }

        public BigDServer(string host)
        ...
        /// </summary>
        public IBigDDatabase GetDatabase(string name)
        {
            return GetDatabase<BigDDatabase>(name);
        }
        ...
        /// </summary>
        public IBigDDatabase GetNewDatabase(string name)
        {
            return GetNewDatabase<BigDDatabase>(name);
        }
        ...
        /// then we recreate it.
        /// </summary>
        public T GetNewDatabase<T>(string name) where T : IBigDDatabase, new()
        {
        ...
        /// </summary>
        public T GetExistingDatabase<T>() where T : IBigDDatabase, new()
        {
        ...
        /// </summary>
        public T GetExistingDatabase<T>(string name) where T : IBigDDatabase, new()
        {
        ...
        /// </summary>
        public T GetDatabase<T>() where T : IBigDDatabase, new()
        {
        ...
        /// </summary>
        public T GetDatabase<T>(string name) where T : IBigDDatabase, new()
        {
        ...
        public void DeleteDatabase(string name)
        {
            ...
            {
                throw new BigDException("Failed to delete database", e);
            }
        }

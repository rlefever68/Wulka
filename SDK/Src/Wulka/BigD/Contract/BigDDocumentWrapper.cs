...
namespace Wulka.BigD.Contract
{
    ...
    public class BigDDocumentWrapper<T>: IBigDbDocument, ISelfContained
    {
        class MemberWrapper
        {
        ...
        protected BigDDocumentWrapper()
        {
            rev = GetFunc("_rev") ?? GetFunc("rev");
            id = GetFunc("_id") ?? GetFunc("id");
        }

        public BigDDocumentWrapper(Func<T> ctor): this()
        {
            instance = ctor();
        }

        public BigDDocumentWrapper(T instance): this()
        {

...
namespace Wulka.BigD.Contract.Lucene
{
    ...
    /// </summary>
    public class BigDLuceneQuery
    {
        public readonly BigDLuceneViewDefinition View;
        ...
        public BigDLuceneViewResult Result;

        public BigDLuceneQuery(BigDLuceneViewDefinition view)
        {
            View = view;
        }
        ...
        /// </summary>
        public BigDLuceneQuery Analyzer(string value)
        {
        ...
        /// </summary>
        public BigDLuceneQuery Callback(string value)
        {
        ...
        /// </summary>
        public BigDLuceneQuery ForceJson()
        {
            Options["force_json"] = "true";
            return this;
        }

        public BigDLuceneQuery IncludeDocuments()
        {
            Options["include_docs"] = "true";
            return this;
        }

        public BigDLuceneQuery Limit(int value)
        {
        ...
        /// </summary>
        public BigDLuceneQuery Q(string value)
        {
            Options["q"] = value;
            return this;
        }
        ...
        /// </summary>
        public BigDLuceneQuery Rewrite()
        {
            Options["rewrite"] = "true";
            return this;
        }

        public BigDLuceneQuery Skip(int value)
        {
        ...
        /// </summary>
        public BigDLuceneQuery Sort(params object[] value)
        {
            if (value != null)
            {
        ...
        /// </summary>
        public BigDLuceneQuery CheckETagUsingHead()
        {

...
namespace Wulka.BigD.Contract.Lucene
{
    ...
    /// </summary>
    public class BigDLuceneViewDefinition : BigDViewDefinitionBase, IEquatable<BigDLuceneViewDefinition>
    {     
        /// <summary>
        ...
        public bool Equals(BigDLuceneViewDefinition other)
        {

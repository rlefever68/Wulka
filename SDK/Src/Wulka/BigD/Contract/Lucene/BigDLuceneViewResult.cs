...
namespace Wulka.BigD.Contract.Lucene
{
	...
	/// </summary>
	public class BigDLuceneViewResult
	{
		private BigDLuceneViewDefinition view;
		public string etag;
		public JObject result;

		public void Result(JObject obj, BigDLuceneViewDefinition aView)
		{
			result = obj;
			view = aView;
		}
		...
		/// </summary>
		public virtual IEnumerable<BigDLuceneHit> Hits()
		{
			var hits = new List<BigDLuceneHit>();
			foreach (JObject row in Rows())
			{
				hits.Add(new BigDLuceneHit(row));
			}
			return hits;
		}
		...
		/// </summary>
		public virtual IEnumerable<T> GetDocuments<T>() where T : IBigDbDocument, new()
		{
			var docs = new List<T>();
